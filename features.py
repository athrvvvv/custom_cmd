...
def ss():
    ...
    isonedrive = os.path.exists(r"%userprofile%\OneDrive")
    if isonedrive == (True):
        image.save(r"%userprofile%\OneDrive\Pictures\Screenshots/"+string_time+".png")
    else:
        image.save(r"%userprofile%\Pictures\Screenshots/"+string_time+".png")
...
def com():
    f = open(os.path.join(main_path,'autogenerated_files','search.txt'), 'r')
    search = f.read()
