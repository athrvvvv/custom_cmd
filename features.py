...
def greet():
    now = datetime.now()
    date = now.strftime("%d.%b.%Y")
    check_file = os.path.exists(r"C:\Users\athar\OneDrive\Documents\projects\custom_cmd\autogenerated_files/"+date+".txt")
    if check_file == (False):
        os.system("echo "+date+" >> "+r"C:\Users\athar\OneDrive\Documents\projects\custom_cmd\autogenerated_files/"+date+".txt")    
        with open(r"C:\Users\athar\OneDrive\Documents\projects\custom_cmd\autogenerated_files/"+date+".txt", "w") as f:
            f.write("GREETED...!!")
            greet_sentence()
...
# def del_greet_file():
    # now = datetime.now()
    # date = now.strftime("%d.%b.%Y")
    # delta = date - date.timedelta(days=1)
    # print(delta)
